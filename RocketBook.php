 ...
 * @ingroup Skins
 */
class SkinRocketBook extends SkinTemplate {
	/** Using rocketbook. */
	function initPage( OutputPage $out ) {
		parent::initPage( $out );
		$this->skinname  = 'rocketbook';
		$this->stylename = 'rocketbook';
		$this->template  = 'RocketBookTemplate';
	...
	function setupSkinUserCss( OutputPage $out ) {
		...
		$out->addStyle( 'rocketbook/main.css', 'screen' );
		if( $wgHandheldStyle ) {
			// Currently in testing... try 'chick/main.css'
			$out->addStyle( $wgHandheldStyle, 'handheld' );
		}

		$out->addStyle( 'rocketbook/IE50Fixes.css', 'screen', 'lt IE 5.5000' );
		$out->addStyle( 'rocketbook/IE55Fixes.css', 'screen', 'IE 5.5000' );
		$out->addStyle( 'rocketbook/IE60Fixes.css', 'screen', 'IE 6' );
		$out->addStyle( 'rocketbook/IE70Fixes.css', 'screen', 'IE 7' );

		$out->addStyle( 'rocketbook/rtl.css', 'screen', '', 'rtl' );
		$out->addStyle( 'rocketbook/theme.css', 'screen' );
	}
}
 ...
 * @ingroup Skins
 */
class RocketBookTemplate extends QuickTemplate {
	var $skin;
	/**
	 * Template filter callback for RocketBook skin.
			...
			$(function(){
				...
				$("td.default span, td.type").each(function(){
					...
					jQuery.each(keywords, function(i,key){
						html = html.replace(new RegExp(key, "ig"), "<a href='http://api.jquery.com/Types#" + key + "'>" + key + "</a>");
					});
					this.innerHTML = html;
				});
				...
				$("div[id=source]").each(function(){
					...
					//iframe.src = "xxx/wiki/index-blank.html";
					iframe.width = "100%";
...
<?php		}
		...
		wfRunHooks( 'RocketBookTemplateToolboxEnd', array( &$this ) );
